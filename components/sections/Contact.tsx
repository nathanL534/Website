    ...
    <section id="contact" className="container mx-auto px-4 md:px-8 py-16 md:py-24">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          {/* Left Side - Simple Resume Card */}
          <div className="relative">
            <div className="backdrop-blur-xl bg-white/60 dark:bg-white/5 border border-black/5 dark:border-white/10 rounded-3xl shadow-2xl p-8 md:p-12">
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4 text-center">
                  ...
                  <p className="text-base leading-relaxed text-slate-600 dark:text-slate-300">
                    I&apos;d love to share my experience and skills with you! 
                ...
                <div className="relative pt-4">
                  <a 
                    ...
                    className="inline-flex items-center gap-2 rounded-full px-8 py-4 font-medium bg-gradient-to-r from-rose-500 to-pink-500 hover:from-rose-600 hover:to-pink-600 text-white shadow-lg ring-1 ring-black/5 hover:shadow-xl transform hover:-translate-y-0.5 transition-all w-full justify-center text-lg"
                  >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-6 border-t border-slate-200 dark:border-slate-700">
                  ...
                  <div className="text-center">
                    <div className="text-sm font-semibold text-slate-600 dark:text-slate-400">Want my resume?</div>
                    <div className="text-base font-bold text-slate-900 dark:text-white">Quick Response</div>
                  </div>
                </div>
              </div>
            </div>
